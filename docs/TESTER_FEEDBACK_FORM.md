...
**Description:** Tried HEARTz? Tell us what worked and what felt confusing. This takes about 2 minutes. Please do not include passwords or private audio files.

1. **What did you try?** Multiple choice, required: Soundscapes / Frequency Lab / Converter / Library / Account or sign-in / Something else.
2. **How easy was it to do what you wanted?** Linear scale 1–5, required. Labels: 1 = Very difficult, 5 = Very easy.
3. **What went well?** Paragraph, optional.
4. **What should we fix or improve first?** Paragraph, required. Ask for the steps they took and what happened if reporting a bug.
5. **What device and browser did you use?** Short answer, optional. Example: iPhone + Safari, Windows + Chrome.

**Confirmation message:** Thanks for helping shape HEARTz. Your feedback helps us decide what to improve next.
